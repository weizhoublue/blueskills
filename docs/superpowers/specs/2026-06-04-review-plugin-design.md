...
- **当前编排（2026-06-04）**：问题驱动 — 主编排出题 + probe-worker + report-assembler；见 [`2026-06-04-audit-code-question-driven-design.md`](2026-06-04-audit-code-question-driven-design.md)。下文六维章节为历史设计参考。
